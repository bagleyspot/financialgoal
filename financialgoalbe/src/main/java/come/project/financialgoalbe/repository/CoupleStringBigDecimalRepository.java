...
public interface CoupleStringBigDecimalRepository extends JpaRepository<CoupleStringBigDecimal,Long> {
	...
	public List<CoupleStringBigDecimal> valueBondDeal(String startDate, String endDate);
	...
	public List<CoupleStringBigDecimal> valueEquityDeal(String startDate, String endDate);
	...
	public List<BigDecimal> getCurrentValueTotal(String startDate);
